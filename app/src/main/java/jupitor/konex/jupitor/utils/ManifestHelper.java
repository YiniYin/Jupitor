...
public class ManifestHelper {
    ...
    public final static String METADATA_DISTRIBUTION_REGION = "DISTRIBUTION_REGION";
    /**
     * The default name for the database unless specified in the AndroidManifest.
     */
    public final static String DATABASE_DEFAULT_NAME = "jupitor.db";

    public static String getDistributionRegion(Context context) {
        String distributionRegion = getMetaDataString(context, METADATA_DISTRIBUTION_REGION);
